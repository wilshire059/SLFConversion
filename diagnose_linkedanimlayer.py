# diagnose_linkedanimlayer.py
# Run the AAA-quality LinkedAnimLayer diagnosis using proper UE5 Cast<> API

import unreal

ANIMBP = "/Game/SoulslikeFramework/Demo/_Animations/Locomotion/AnimBP/ABP_SoulslikeCharacter_Additive"
OUTPUT_FILE = "C:/scripts/SLFConversion/migration_cache/linkedanimlayer_diagnosis.txt"
