# export_animbp_bponly.py
# Export complete AnimBP state from bp_only (golden reference) using C++ function

import unreal

ANIMBP_PATH = "/Game/SoulslikeFramework/Demo/_Animations/Locomotion/AnimBP/ABP_SoulslikeCharacter_Additive"
OUTPUT_PATH = "C:/scripts/SLFConversion/migration_cache/animbp_cpp_export_bponly.txt"

def main():
    print("[Export] Starting complete AnimBP export from bp_only via C++...")
    unreal.log_warning("[Export] Starting complete AnimBP export from bp_only via C++...")
