# verify_destructibles.py
# Verify destructible-related Blueprints are properly migrated
...
def main():
    ...
    unreal.log_warning("VERIFYING DESTRUCTIBLE BLUEPRINTS")
    unreal.log_warning("=" * 60)
    ...
    for bp_path in BLUEPRINTS:
        ...
        # Check parent class
        try:
            parent_class = gen_class.static_class().get_class_path_name()
            unreal.log_warning(f"  Class path: {parent_class}")
        except:
            pass

        # Get parent from Blueprint itself
        try:
        ...
        if cdo:
            ...
            try:
                ...
                if root:
                    ...
                    unreal.log_warning(f"  Root component: None")
