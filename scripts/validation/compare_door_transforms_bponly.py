"""
Compare B_Door_Demo component transforms - bp_only version
"""
import unreal
import json
...
unreal.log("=" * 70)
unreal.log("B_Door_Demo TRANSFORM COMPARISON - bp_only")
unreal.log("=" * 70)
...
# Save results
output_path = "C:/scripts/SLFConversion/migration_cache/door_transforms_bponly.json"
