"""
Clear event graphs and reparent W_Settings Blueprint to C++ class.

Run with:
"C:/Program Files/Epic Games/UE_5.7/Engine/Binaries/Win64/UnrealEditor-Cmd.exe" ^
  "C:/scripts/SLFConversion/SLFConversion.uproject" ^
  -run=pythonscript -script="C:/scripts/SLFConversion/fix_w_settings_reparent.py" ^
...
def main():
    ...
    unreal.log_warning("Fixing W_Settings - Clear and Reparent")
    unreal.log_warning("=" * 70)
