...
MIGRATION_MAP = {
    ...
    # "B_BaseCharacter": "/Script/SLFConversion.SLFBaseCharacter",  # In KEEP_VARS_MAP
    # "B_Soulslike_Character": "/Script/SLFConversion.SLFSoulslikeCharacter",  # In KEEP_VARS_MAP
    ...
    "B_Item_AI_Weapon": "/Script/SLFConversion.SLFItemBase",
    "B_Item_AI_Weapon_BossMace": "/Script/SLFConversion.SLFItemBase",
    "B_Item_AI_Weapon_Greatsword": "/Script/SLFConversion.SLFItemBase",
    "B_Item_AI_Weapon_Sword": "/Script/SLFConversion.SLFItemBase",
    "B_Item_Weapon_BossMace": "/Script/SLFConversion.SLFItemBase",
    "B_Item_Weapon_Greatsword": "/Script/SLFConversion.SLFItemBase",
    "B_Item_Weapon_Katana": "/Script/SLFConversion.SLFItemBase",
    "B_Item_Weapon_PoisonSword": "/Script/SLFConversion.SLFItemBase",
    "B_Item_Weapon_SwordExample01": "/Script/SLFConversion.SLFItemBase",
    "B_Item_Weapon_SwordExample02": "/Script/SLFConversion.SLFItemBase",
...
KEEP_VARS_MAP = {
    ...
    "AC_AI_SenseManager": "/Script/SLFConversion.AC_AI_SenseManager",
    "AC_AI_TargetSortManager": "/Script/SLFConversion.AC_AI_TargetSortManager",
    # Character Blueprints with component variables that conflict with C++ parent
...
# AnimBlueprints - special handling: clear EventGraph, reparent to C++ AnimInstance
# AnimBPs: Manually cleared by user - skip entirely to avoid AnimGraph conflicts
ANIM_BP_MAP = {
    # These cause 'duplicate AnimGraph function' errors when processed
    # User has manually cleared EventGraphs in the backup
...
PRIORITY_CHARACTER_MAP = {
    # B_Soulslike_Character moved to KEEP_VARS_MAP - has component variables that conflict with C++ parent
    "B_Soulslike_Enemy": "/Script/SLFConversion.SLFSoulslikeEnemy",
    "B_Soulslike_Boss": "/Script/SLFConversion.SLFSoulslikeBoss",
}
...
# Skip list - empty, fix root cause instead of skipping
SKIP_LIST = set()
...
def run():
    ...
    LOAD_SKIP_LIST = [
        "B_Container",
        "B_PickupItem",
        # Priority characters are now processed explicitly via PRIORITY_CHARACTER_MAP
        # "B_Soulslike_Character",  # Now in PRIORITY_CHARACTER_MAP
        # "B_Soulslike_Enemy",      # Now in PRIORITY_CHARACTER_MAP
        # "B_Soulslike_Boss",       # Now in PRIORITY_CHARACTER_MAP
        # "B_BaseCharacter",        # Now in PRIORITY_CHARACTER_MAP
        # NPC Blueprints now processed via NPC_CHARACTER_MAP
        # "B_Soulslike_NPC",                # Now in NPC_CHARACTER_MAP
        # "B_Soulslike_NPC_ShowcaseGuide",  # Now in NPC_CHARACTER_MAP
        # "B_Soulslike_NPC_ShowcaseVendor", # Now in NPC_CHARACTER_MAP
        # Enemy subclasses still need parent cleared first
    ...
    # Character Blueprints removed - their logic is now cleared via PRIORITY_CHARACTER_MAP
    REPARENT_SKIP_LIST = [
        "B_Container",
        "B_PickupItem",
        # Character Blueprints now safe to reparent since logic is cleared first
        # "B_Soulslike_Character",  # Moved to PRIORITY_CHARACTER_MAP
        # "B_Soulslike_Enemy",      # Moved to PRIORITY_CHARACTER_MAP  
        # "B_Soulslike_Boss",       # Moved to PRIORITY_CHARACTER_MAP
        # NPC Blueprints now processed via NPC_CHARACTER_MAP
        # "B_Soulslike_NPC",        # Moved to NPC_CHARACTER_MAP
    ]
    ...
    print("=" * 60)
    print("(Compilation skipped to avoid engine crashes from corrupted BPs)")
    print("(Assets will compile on next editor open)")
    compile_ok = 0
    compile_fail = 0
    ...
    print("Saved: " + str(saved))
    print("Compile: SKIPPED (deferred to editor open)")
    print("=" * 60)
