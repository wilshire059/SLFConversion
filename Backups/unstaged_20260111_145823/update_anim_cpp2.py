...
with open("Source/SLFConversion/Animation/ABP_SoulslikeCharacter_Additive.cpp", "r", encoding="utf-8") as f:
    content = f.read()
...
new = '''	// VERBOSE DEBUG: Log FIRST call to confirm C++ AnimInstance is running
	static bool bFirstCall = true;
	if (bFirstCall)
	{
		bFirstCall = false;
...
if old in content:
    ...
    print("First call pattern not found - may already be updated")
...
new2 = '''	// DEBUG: Log state every second (60 frames at 60fps)
...
if old2 in content:
    ...
    print("Periodic logging pattern not found - may already be updated")

with open("Source/SLFConversion/Animation/ABP_SoulslikeCharacter_Additive.cpp", "w", encoding="utf-8") as f:
    f.write(content)
