...
protected:
	...
	/** Cache component references from Blueprint SCS - same pattern as SLFSoulslikeCharacter */
	void CacheComponentReferences();

	/** Handle AI perception updates - set target when player is perceived */
	UFUNCTION()
...
public:
	...
	// ═══════════════════════════════════════════════════════════════════
	// COMPONENT CACHE (populated in BeginPlay via FindComponentByClass)
	// These components are created by Blueprint SCS, NOT C++ constructor
	// Following the same pattern as SLFSoulslikeCharacter
	// ═══════════════════════════════════════════════════════════════════

	/** Cached AI Combat Manager - find via FindComponentByClass (Blueprint SCS creates "AC_AI_CombatManager") */
	UPROPERTY(BlueprintReadOnly, Category = "Components")
	TObjectPtr<UAICombatManagerComponent> CombatManagerComponent;

	/** Cached AI Behavior Manager - find via FindComponentByClass (Blueprint SCS creates "AC_AI_BehaviorManager") */
	UPROPERTY(BlueprintReadOnly, Category = "Components")
