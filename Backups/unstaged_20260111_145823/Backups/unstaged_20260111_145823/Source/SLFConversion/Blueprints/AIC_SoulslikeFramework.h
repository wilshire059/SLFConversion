...
class SLFCONVERSION_API AAIC_SoulslikeFramework : public AAIController, public ISLFAICInterface
{
	GENERATED_BODY()
...
private:
	float BTDebugTimer = 0.0f;
	static constexpr float BTDebugInterval = 2.0f;
