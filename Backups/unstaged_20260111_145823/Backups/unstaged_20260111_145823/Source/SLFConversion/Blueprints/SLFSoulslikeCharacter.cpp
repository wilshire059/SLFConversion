...
// ═══════════════════════════════════════════════════════════════════════════════
// ANIMINSTANCE STATE SYNC - Updates AnimBP variables from C++ components
//
// POST-MIGRATION FIX: After clearing AnimBP EventGraph, the component reference
// variables (ActionManager, CombatManager, EquipmentManager) are NULL.
// The AnimGraph's Property Access nodes read from these, so we must set them here.
// ═══════════════════════════════════════════════════════════════════════════════
