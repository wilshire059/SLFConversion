# apply_item_tags_v2.py
# Apply GameplayTags to item assets using GameplayTagsManager
...
def main():
    log("=== Applying Item Tags (v2) ===")

    # Get GameplayTagsManager
    tags_manager = unreal.GameplayTagsManager.get()
    ...
    for item_name, tag_str in ITEM_TAGS.items():
        ...
        try:
            ...
            # Request the gameplay tag via manager
            tag = tags_manager.request_gameplay_tag(unreal.Name(tag_str), False)
