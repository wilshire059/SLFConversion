...
unreal.log("=" * 70)
unreal.log("B_Door Mesh Analysis (bp_only)")
unreal.log("=" * 70)
                ...
                if node:
                    ...
                    if template:
                        ...
                        if isinstance(template, unreal.StaticMeshComponent):
                            ...
                            scs_info["mesh_path"] = mesh.get_path_name() if mesh else "None"
...
# Save to SLFConversion migration_cache
output_path = "C:/scripts/SLFConversion/migration_cache/door_analysis_bponly.json"
