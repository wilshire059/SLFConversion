...
// C++ Animation Notify for AN_InterruptMontage
//
// 20-PASS VALIDATION: 2026-01-01 Autonomous Session
// Source: BlueprintDNA/Animation/AN_InterruptMontage.json
// Parent: UAnimNotify
...
UCLASS()
class SLFCONVERSION_API UAN_InterruptMontage : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAN_InterruptMontage();
