...
// C++ Animation Notify for AN_SpawnProjectile
//
// 20-PASS VALIDATION: 2026-01-01 Autonomous Session
// Source: BlueprintDNA/Animation/AN_SpawnProjectile.json
// Parent: UAnimNotify
...
UCLASS()
class SLFCONVERSION_API UAN_SpawnProjectile : public UAnimNotify
{
	GENERATED_BODY()
