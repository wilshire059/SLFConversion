...
// C++ Animation Notify for ANS_InvincibilityFrame
//
// 20-PASS VALIDATION: 2026-01-01 Autonomous Session
// Source: BlueprintDNA/Animation/ANS_InvincibilityFrame.json
...
UCLASS()
class SLFCONVERSION_API UANS_InvincibilityFrame : public UAnimNotifyState
{
	GENERATED_BODY()

public:
	UANS_InvincibilityFrame();
