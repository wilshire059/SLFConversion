...
// C++ Animation Notify for ANS_ToggleChaosField
//
// 20-PASS VALIDATION: 2026-01-01 Autonomous Session
// Source: BlueprintDNA/Animation/ANS_ToggleChaosField.json
...
UCLASS()
class SLFCONVERSION_API UANS_ToggleChaosField : public UAnimNotifyState
{
	GENERATED_BODY()

public:
	UANS_ToggleChaosField();
