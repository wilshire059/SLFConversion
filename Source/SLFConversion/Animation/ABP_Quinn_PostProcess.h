// ABP_Quinn_PostProcess.h
// C++ AnimInstance for ABP_Quinn_PostProcess
//
// 20-PASS VALIDATION: 2026-01-01 Autonomous Session
// Source: BlueprintDNA/AnimBlueprint/ABP_Quinn_PostProcess.json
...
UCLASS()
class SLFCONVERSION_API UABP_Quinn_PostProcess : public UAnimInstance
{
	GENERATED_BODY()

public:
	UABP_Quinn_PostProcess();
