// BTS_SetMovementModeBasedOnDistance.h
// C++ AI class for BTS_SetMovementModeBasedOnDistance
//
// 20-PASS VALIDATION: 2026-01-01 Autonomous Session
// Source: BlueprintDNA/AI/BTS_SetMovementModeBasedOnDistance.json
...
UCLASS()
class SLFCONVERSION_API UBTS_SetMovementModeBasedOnDistance : public UBTService_BlueprintBase
{
	GENERATED_BODY()
