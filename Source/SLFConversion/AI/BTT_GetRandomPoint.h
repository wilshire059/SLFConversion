// BTT_GetRandomPoint.h
// C++ AI class for BTT_GetRandomPoint
//
// 20-PASS VALIDATION: 2026-01-01 Autonomous Session
// Source: BlueprintDNA/AI/BTT_GetRandomPoint.json
...
UCLASS()
class SLFCONVERSION_API UBTT_GetRandomPoint : public UBTTask_BlueprintBase
{
	GENERATED_BODY()
