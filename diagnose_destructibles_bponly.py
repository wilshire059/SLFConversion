"""
Diagnose B_Destructible in bp_only for comparison.
"""

import unreal
import os

def diagnose_destructible_bponly():
    """Diagnose B_Destructible Blueprint in bp_only."""
    ...
    log("\n" + "="*80)
    log("B_Destructible Diagnosis (bp_only)")
    log("="*80)
    ...
    if cdo:
        ...
        try:
            ...
            if gc:
                ...
                log(f"  GeometryCollection: None (NOT SET)")
        except Exception as e:
            log(f"  GeometryCollection: Property not found - {e}")
        ...
        try:
            ...
            if ds:
                ...
                log(f"  DestructionSound: None")
        except Exception as e:
            log(f"  DestructionSound: Property not found - {e}")
        ...
        try:
            ...
            log(f"  Error getting all components: {e}")
    ...
    # Write to file
    output_path = "C:/scripts/SLFConversion/migration_cache/destructible_diagnosis_bponly.txt"
